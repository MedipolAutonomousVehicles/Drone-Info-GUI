...
class Gui:
    ...
    def layout(self):
        ...
        self.sendButton = ttk.Button(secondFrame, text="Start",command=self.sendDatas)
    ...
    def refresh(self):
        # Clear Value labels
        emptyData = {"Takım Numarası":"","GPS Saat":"","GPS Dakika":"","GPS Saniye":"","GPS Salise":"",
    ...
    def queue(self):
        #sleep(1)
        self.root.after(1000,self.sendDatas)
    ...
    def dataLayout(self):
        ...
        uavMode = Label(fourthFrame, text="İHA Modu:")
